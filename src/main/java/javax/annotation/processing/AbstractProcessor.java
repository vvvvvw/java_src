...
public abstract class AbstractProcessor implements Processor {
     ...
     */
    protected ProcessingEnvironment processingEnv; //注解处理器框架提供的一个上下文环境，要创建新的代码、向编译器输出信息、获取其他工具类等都需要用到这个实例变量
     ...
     * {@inheritDoc}
     */
    public abstract boolean process(Set<? extends TypeElement> annotations,//Javac编译器在执行注解处理器所要处理的注解集合
                                    RoundEnvironment roundEnv);//访问当前这个Round中的语法树节点，每个语法树节点在这里表示为一个Element
